...
#if defined(CONFIG_TARGET_DRA7XX_EVM) || defined(CONFIG_TARGET_AM57XX_EVM) || defined(CONFIG_TARGET_ELESAR_TITANIUM)
...
#else
static void ft_opp_clock_fixups(void *fdt, bd_t *bd) { }
#endif /* CONFIG_TARGET_DRA7XX_EVM || CONFIG_TARGET_AM57XX_EVM  || CONFIG_TARGET_ELESAR_TITANIUM */
