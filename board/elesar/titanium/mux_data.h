...
const struct pad_conf_entry core_padconf_array_essential[] = {
	...
	{MCASP3_FSX, (M0 | PIN_INPUT)},		/* mcasp3_fsx.mcasp3_fsx (AUD_0_WCLK) */
	...
	{MMC1_CLK, (M0 | PIN_INPUT)},		/* mmc1_clk.mmc1_clk (MMC1_CLK) */
	{MMC1_CMD, (M0 | PIN_INPUT)},		/* mmc1_cmd.mmc1_cmd (MMC1_CMD) */
	...
	{GPIO6_10, (M14 | PIN_INPUT)},		/* gpio6_10.gpio6_10 (USB1_E_nOC0) */
	{GPIO6_11, (M14 | PIN_INPUT)},		/* gpio6_11.gpio6_11 (USB1_E_nOC1) */
	...
	{DCAN1_TX, (M15 | PIN_INPUT_PULLUP)},	/* dcan1_tx.safe (DCAN1_TX) */
	{DCAN1_RX, (M15 | PIN_INPUT_PULLUP)},	/* dcan1_rx.safe (DCAN1_RX) */
	...
	{WAKEUP2, (M1 | PULL_DIS)},		/* wakeup2.sys_nirq2 */
	{WAKEUP3, (M1 | PULL_DIS)},		/* wakeup3.sys_nirq1 */
};
...
const struct pad_conf_entry late_padconf[] = {
	{GPMC_A13, (M1 | PIN_INPUT)},		/* gpmc_a13.qspi1_rtclk (QSPI_1_RTCLK) */
	{GPMC_A14, (M1 | PIN_INPUT)},		/* gpmc_a14.qspi1_d3 (QSPI_1_D3) */
	{GPMC_A15, (M1 | PIN_INPUT)},		/* gpmc_a15.qspi1_d2 (QSPI_1_D2) */
	{GPMC_A16, (M1 | PIN_INPUT)},		/* gpmc_a16.qspi1_d1 (QSPI_1_D1) */
